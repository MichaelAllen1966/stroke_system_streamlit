...
params['prop_hasu_using_esd_only'] = st.sidebar.number_input('Proportion HASU using ESD only', value=params['prop_hasu_using_esd_only'], step=0.05)
...
params['los_asu_no_esd_mean'] = st.sidebar.number_input('Mean LOS ASU no ESD', value=params['los_asu_no_esd_mean'], step=0.5)
params['los_asu_with_esd_mean'] = st.sidebar.number_input('Mean LOS ASU with ESD', value=params['los_asu_with_esd_mean'], step=1)
params['los_esd_mean'] = st.sidebar.number_input('Mean LOS ESD', value=params['los_esd_mean'],step=1)
